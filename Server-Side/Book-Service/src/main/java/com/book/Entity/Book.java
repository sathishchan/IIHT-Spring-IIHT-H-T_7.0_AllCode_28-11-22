...
public class Book {
	...
	public Book(Long id, String image, String title, String category, Float price, String author, String publisher,
			LocalDate publishedDate, LocalDateTime createdTime, LocalDateTime updatedTime, Boolean is_active,
			Set<BookContent> bookContent, Set<BookSubscription> bookSubscription) {
		super();
		this.id = id;
		this.image = image;
		this.title = title;
	...
	public String toString() {
		return "Book [id=" + id + ", image=" + image + ", title=" + title + ", category=" + category + ", price="
				...
				+ ", createdTime=" + createdTime + ", updatedTime=" + updatedTime + ", is_active=" + is_active
				+ ", bookContent=" + bookContent + ", bookSubscription=" + bookSubscription + "]";
	}
